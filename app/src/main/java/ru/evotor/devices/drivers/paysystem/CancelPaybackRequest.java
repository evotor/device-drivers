...
public record CancelPaybackRequest(int instanceId,
                                   @NotNull BigDecimal sum,
                                   @Nullable Date expiredAt,
                                   @Nullable String additionalDescription,
                                   @NotNull String rrn,
                                   @Nullable String transactionId) implements Parcelable {
    ...
    public static final Creator<CancelPaybackRequest> CREATOR = new Creator<>() {

        public CancelPaybackRequest createFromParcel(Parcel in) {
            return ParcelableUtils.readExpandData(
                    in,
                    ( currentVersion) -> new CancelPaybackRequest(
                            in.readInt(),
