...
# __2.1. SDK для принтера Эвотор.(#2111)__
_Содержание:_  
2.1.1  [Подключение к своему проекту библиотеку для работы с оборудованием.](#2011)  
2.1.2. [Определение внешний сервис в `AndroidManifest.xml` приложения](#2012).  
...
в модуле `build.gradle` добавьте точную версию софта (текущая: 1.2.0+), про зависимость следующим образом:
