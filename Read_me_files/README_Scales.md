...
_Содержание:_  
1.5.1. [Определение внешний сервис в `AndroidManifest.xml` приложения](#307).  
1.5.2. [Определение роли и категории устройства.](#301)  
1.5.3. [Присвоение картинки для драйвера](#302)  
1.5.4. [В реализации метода подключения к сервису для всех action указанных в интент-фильтрах укажите соответствующие `Binder'ы`](#303)  
1.5.5. [Описание указанных `Binder'ов`.](#304)  
1.5.6. [Описание класса для работы с оборудованием.](#305)  
1.5.7. [Завершение работы.](#306)

<a name="307"></a>
### 1.3.1. Определение внешний сервис в `AndroidManifest.xml` приложения.
